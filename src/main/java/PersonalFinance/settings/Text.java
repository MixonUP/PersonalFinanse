...
final public class Text {
    ...
    public static String get(String key) {
        ...
        System.out.println("Tакого ключа в Text не существует!");       // Для отладки
        return "";
    }
    ...
    public static void init() {
        ...
        data.put("ERROR_RATE_INCORRECT", "Неккоректное значение курса!");
        data.put("ERROR_AMOUNT_FORMAT", "Неккоректный формат суммы!");
